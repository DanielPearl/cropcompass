...
class NassCropAnimals(models.Model):
    ...
    def __unicode__(self):
        return "{} {}".format(self.crop, self.year)
...
class NassCropArea(models.Model):
    crop = models.CharField(max_length=64, blank=True, null=True)
    year = models.SmallIntegerField(blank=True, null=True)
    fips = models.IntegerField(blank=True, null=True)
...
class NassCropFarms(models.Model):
    crop = models.CharField(max_length=64, blank=True, null=True)
    year = models.SmallIntegerField(blank=True, null=True)
    fips = models.IntegerField(blank=True, null=True)
